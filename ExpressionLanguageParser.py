...
def p_if_statement(p):
    '''if_statement : IF expression_relacional LBRACE block_statement RBRACE'''
    p[0] = sa.OnlyIf(p[2], p[4])

def p_if_statement_else(p):
    '''if_statement : IF expression_relacional LBRACE block_statement RBRACE elseop'''
...
def p_else2(p):
    '''elseop : ELSE LBRACE block_statement RBRACE'''
    p[0] = sa.OnlyElse(p[3])
...
def p_for_statement(p):
    '''for_statement : FOR declaration_imutable SEMICOLON expression_relacional SEMICOLON increment LBRACE block_statement RBRACE'''
    p[0] = sa.ConventionalFor(p[2], p[4], p[6], p[8])

def p_for_statement2(p):
    '''for_statement : FOR expression_relacional LBRACE block_statement RBRACE'''
